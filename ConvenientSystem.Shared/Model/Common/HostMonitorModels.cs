namespace ConvenientSystem.Shared.Model.Common
{
    ...
    public class HostMetricsHistoryDto
    {
        /// <summary>最新一次采集的完整快照（统计卡/磁盘分区表用）</summary>
        public HostMetricsSnapshot? Latest { get; set; }
        /// <summary>时间序列历史点（图表用，按时间升序）</summary>
        public List<HostMetricsPointDto> History { get; set; } = new();
    }

    /// <summary>整机概览时间序列点（图表用）</summary>
    public class HostMetricsPointDto
    {
        ...
        /// <summary>已用内存 GB</summary>
        public decimal? MemoryUsedGb { get; set; }
        /// <summary>网络接收 KB/s</summary>
        public decimal? NetInKbps { get; set; }
        /// <summary>网络发送 KB/s</summary>
        public decimal? NetOutKbps { get; set; }
        /// <summary>磁盘读 MB/s</summary>
        public decimal? DiskReadMbPerSec { get; set; }
        /// <summary>磁盘写 MB/s</summary>
        public decimal? DiskWriteMbPerSec { get; set; }
    }

    /// <summary>主机监控目标列表项 DTO</summary>
    public class HostMonitorTargetDto
    {
        public int Id { get; set; }
        /// <summary>监控目标名称</summary>
        public string Name { get; set; } = string.Empty;
        /// <summary>指标类型（DISK/MEM/CPU/SVC/HOST）</summary>
        public string MetricType { get; set; } = "DISK";
        /// <summary>目标电脑 IP/主机名（空=本机）</summary>
        public string? HostAddress { get; set; }
        /// <summary>目标是否实际为本机（地址为空或指向本机：环回/计算机名/本机网卡 IP）</summary>
        public bool IsLocal { get; set; }
        /// <summary>远程采集账号（不含密码）</summary>
        public string? AuthAccount { get; set; }
        /// <summary>整机概览最近指标快照 JSON（仅 HOST）</summary>
        public string? MetricsJson { get; set; }
        /// <summary>磁盘盘符（仅 DISK）</summary>
        public string? DriveLetter { get; set; }
        /// <summary>服务名列表（仅 SVC）</summary>
        public string? ServiceNames { get; set; }
        /// <summary>告警阈值百分比</summary>
        ...
        /// <summary>最近探测值（%；SVC 为运行中服务数）</summary>
    ...
    /// <summary>主机监控目标新增/编辑 DTO（Id 为空表示新增）</summary>
    public class HostMonitorTargetSaveDto
    {
        public int? Id { get; set; }
        /// <summary>监控目标名称</summary>
        public string Name { get; set; } = string.Empty;
        /// <summary>指标类型（DISK/MEM/CPU/SVC/HOST）</summary>
        public string MetricType { get; set; } = "DISK";
        /// <summary>目标电脑 IP/主机名（空=本机；远程目标采集需 WinRM）</summary>
        public string? HostAddress { get; set; }
        /// <summary>远程采集账号（远程目标必填）</summary>
        public string? AuthAccount { get; set; }
        /// <summary>远程采集密码（编辑时留空=不修改原密码）</summary>
        public string? AuthPassword { get; set; }
        /// <summary>磁盘盘符（如 C；空=所有固定磁盘，仅 DISK 有效）</summary>
        public string? DriveLetter { get; set; }
        /// <summary>服务名列表（逗号分隔，仅 SVC 有效）</summary>
        public string? ServiceNames { get; set; }
        /// <summary>告警阈值百分比（0-100）</summary>
        public decimal? ThresholdPercent { get; set; }
        /// <summary>单次探测超时（秒）</summary>
    ...
    /// <summary>主机监控探测日志 DTO</summary>
    public class HostMonitorLogDto
    {
        public long Id { get; set; }
        /// <summary>探测结果：1=正常 2=异常</summary>
        public byte Status { get; set; }
        /// <summary>探测值（%；SVC 为运行中服务数）</summary>
