...
internal sealed class QuickLauncher : Form
{
    ...
    private static readonly Color Brand = UiStyle.BrandBlue;
    ...
    private static readonly Color SubColor = UiStyle.TextSecondary;
    private static readonly Color BorderColor = UiStyle.BorderColor;
